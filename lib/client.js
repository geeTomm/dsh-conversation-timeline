window.__ModuleLoader__.load({
  id: "@dsh-external/dsh-conversation-browser",
  factory: (require) => {
    var module = { exports: {} };
    ...
    const API_BASE = "/conversation-browser/api";
    ...
    exports.apply = function (ctx) {
      ctx.effect(
        () =>
          ctx.slots.register({
            name: "shell.overlay",
            id: "@dsh-external/dsh-conversation-browser-overlay",
            order: 100,
          }, TimelineOverlayBoundary),
        "@dsh-external/dsh-conversation-browser: overlay"
      );
    };
